...
urlpatterns = [
    ...
    path("videos/details/<str:pk>", views.VideoDetails.as_view(), name="video-details"),
    path("videos/add-video-form", views.AddVideoForm.as_view(), name="add-video-form"),
    ...
    path("api/videos/add-video", views.AddVideo.as_view(), name="add-video"),
